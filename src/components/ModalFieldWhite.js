...
export default class ModalField extends Component {
  ...
  render () {
    ...
    let Icon = (finished ? (this.props.warning ? Warning : Complete) : Required)
    ...
    return (
      <View style={[box.button, override, this.props.localStyle, mode]}>
        ...
        {doneShow && <Done label={'DONE'} action={this.submitFromAction} />}
        <Icon />
      </View>
    )
  }
...
class Complete extends Component {
  render () {
    return (
      <View style={[iconStyles.layout, iconStyles.complete]}>
